...
#  read shape
shp <- st_read("inputs/dissolved_aoi.shp") %>% 
...
bps_conus_atts <- read.csv("D:/landfire_R_experiment/conus_inputs/LF2016_BPS_200_CONUS/LF2016_BPS_200_CONUS/CSV_Data/LF16_BPS_200.csv")
...
```{r}
evc_aoi <- rast("D:/landfire_R_experiment/conus_inputs/LF2022_EVC_230_CONUS_acc/LF2022_EVC_230_CONUS/Tif/LC22_EVC_230.tif") %>%
  crop(shp) %>%
  mask(shp)


evc_conus_atts <- read.csv("D:/landfire_R_experiment/conus_inputs/LF2022_EVC_230_CONUS_acc/LF2022_EVC_230_CONUS/CSV_Data/LF22_EVC_230_acc.csv")
...
```{r}
evh_aoi <- rast("D:/landfire_R_experiment/conus_inputs/LF2022_EVH_230_CONUS_acc/LF2022_EVH_230_CONUS/Tif/LC22_EVH_230.tif") %>%
  crop(shp) %>%
  mask(shp)


evh_conus_atts <- read.csv("D:/landfire_R_experiment/conus_inputs/LF2022_EVH_230_CONUS_acc/LF2022_EVH_230_CONUS/CSV_Data/LF22_EVH_230_acc.csv")
